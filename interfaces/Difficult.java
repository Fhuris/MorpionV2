	...
	public Difficult(){
		...
		izy.addActionListener(new ActionListener() { 
			...
			public void actionPerformed(ActionEvent arg0) {
				System.out.println("Vous allez jouez contre un tard");
				setVisible(false);
				Grille frame=new Grille(1);
		...
		medium.addActionListener(new ActionListener() { 
			@Override
			public void actionPerformed(ActionEvent arg0) {
				System.out.println("Vous allez jouez contre une IA bidon");
				setVisible(false);	
				Grille frame=new Grille(2);
				frame.setVisible(true);
			}
		});
